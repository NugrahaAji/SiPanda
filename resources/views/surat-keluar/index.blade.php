                            ...
                            <table class="min-w-full divide-y divide-gray-600 rounded-lg">
                                <thead class="bg-zinc-800">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Tanggal surat</th>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Tanggal Keluar</th>
                                ...
                                <tbody class="bg-zinc-900 divide-y divide-gray-600">
                                    @foreach($suratKeluar as $surat)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-white">{{ \Carbon\Carbon::parse($surat->tanggal_surat)->format('d/m/Y') }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-white">{{ \Carbon\Carbon::parse($surat->tanggal_keluar)->format('d/m/Y') }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-white">{{ $surat->perihal }}</td>
