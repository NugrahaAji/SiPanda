                ...
                <div class="p-6">
                    <div class="space-y-4 text-white/90">
                        ...
                        <div class="flex items-center justify-end space-x-4 mt-6">
                            <a href="{{ route('surat-keluar.index') }}" class="text-gray-400 hover:text-gray-300" title="Kembali">
                            ...
                            <a href="{{ route('surat-keluar.edit', $suratKeluar) }}" class="text-yellow-600 hover:text-yellow-900" title="Edit">
                            ...
                            <form action="{{ route('surat-keluar.destroy', $suratKeluar) }}" method="POST" onsubmit="return confirm('Hapus surat ini?');" class="inline">
                                @csrf
                                @method('DELETE')
